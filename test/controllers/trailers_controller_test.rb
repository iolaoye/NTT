...
class TrailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trailer" do
    assert_difference('Trailer.count') do
      post trailers_url, params: { trailer: { code: @trailer.code, description: @trailer.description } }
    end
  ...
  test "should update trailer" do
    patch trailer_url(@trailer), params: { trailer: { code: @trailer.code, description: @trailer.description } }
