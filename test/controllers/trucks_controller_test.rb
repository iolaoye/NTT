...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { class: @truck.class, description: @truck.description } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { class: @truck.class, description: @truck.description } }
