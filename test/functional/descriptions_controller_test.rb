...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { description: @description.description, detail: @description.detail, position: @description.position, unit: @description.unit }
    end
  ...
  test "should update description" do
    put :update, id: @description, description: { description: @description.description, detail: @description.detail, position: @description.position, unit: @description.unit }
    assert_redirected_to description_path(assigns(:description))
  end
