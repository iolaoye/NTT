...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { state_code: @state.state_code, state_name: @state.state_name, status: @state.status }
    end
  ...
  test "should update state" do
    put :update, id: @state, state: { state_code: @state.state_code, state_name: @state.state_name, status: @state.status }
    assert_redirected_to state_path(assigns(:state))
  end
