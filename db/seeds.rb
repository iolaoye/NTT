...
Tillage.create!({:id => 162,:code => 231,:dndc => 0,:name => 'VRIPPER',:operation => 0,:eqp => 'V-RIPPER',:status => true,:abbreviation => 'TILL',:spanish_name =>  'Destripador en V',:activity_id => 3}, :without_protection => true)
