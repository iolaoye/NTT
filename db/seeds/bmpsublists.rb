...
Bmpsublist.create!({:id => 22,:name => "Monthly Temperature and Precipitation Changes",:status => true,:bmplist_id => 7,:spanish_name => "Cambios de Temperatura y Precipitacion"}, :without_protection => true)
Bmpsublist.create!({:id => 23,:name => "Asphalt or Concrete",:status => true,:bmplist_id => 8,:spanish_name => "Asfalto o Concreto"}, :without_protection => true)
Bmpsublist.create!({:id => 24,:name => "Grass Cover",:status => true,:bmplist_id => 8,:spanish_name => "Cubierta de Pasto"}, :without_protection => true)
Bmpsublist.create!({:id => 25,:name => "Slope Adjustment",:status => true,:bmplist_id => 8,:spanish_name => "Ajuste de la inclinacion"}, :without_protection => true)
Bmpsublist.create!({:id => 26,:name => "Shading",:status => true,:bmplist_id => 8,:spanish_name => "Shading"}, :without_protection => true)