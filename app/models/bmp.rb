...
class Bmp < ActiveRecord::Base
  ...
  #validations
    ...
    validates :days, numericality: { greater_than: 0,  less_than_or_equal_to: 365 }, if: "bmpsublist_id == 1 || bmpsublist_id == 2 || bmpsublist_id == 10"
    validates :hours, numericality: { greater_than: 0 }, if: "bmpsublist_id == 10"
    validates :dry_manure, numericality: { greater_than: 0 }, if: "bmpsublist_id == 10"
    validates :no3_n, numericality: { greater_than: 0 }, if: "bmpsublist_id == 10"
    validates :po4_p, numericality: { greater_than: 0 }, if: "bmpsublist_id == 10"
    validates :org_n, numericality: { greater_than: 0 }, if: "bmpsublist_id == 10"
    validates :org_p, numericality: { greater_than: 0 }, if: "bmpsublist_id == 10"
    validates :width, numericality: { greater_than: 0 }, if: "bmpsublist_id == 4 || bmpsublist_id == 5 || bmpsublist_id == 6 || bmpsublist_id == 7 || bmpsublist_id == 12 || bmpsublist_id == 13 || bmpsublist_id == 14 || bmpsublist_id == 15 || bmpsublist_id == 23"
    validates :grass_field_portion, numericality: { greater_than_or_equal_to: 0.25, less_than_or_equal_to: 0.75 }, if: "bmpsublist_id == 12"
    ...
    validate :only_one_from_group, if: 'bmpsublist_id > 3 && bmpsublist_id < 8 || bmpsublist_id > 11 && bmpsublist_id < 16'
  #Functions
