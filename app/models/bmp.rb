...
class Bmp < ActiveRecord::Base
  ...
  #validations
    ...
    validates :area, numericality: { greater_than: 0,  less_than_or_equal_to: 100000 }, if: "bmpsublist_id == 6 || bmpsublist_id == 7 || bmpsublist_id == 8 || bmpsublist_id == 12 || bmpsublist_id == 13"
