class Operation < ActiveRecord::Base
  ...
  belongs_to :scenario
  #validations
    #validates_uniqueness_of :crop_id, :scope => [:activity_id, :year, :month_id, :day, :type_id, :subtype_id, :scenario_id] commentarized because two fertilizer application can be the same except for nutrients and amount
