			...
			if @type.include? t('general.view') then
					...
					if @scenario1 > "0" then
						...
						if session[:simulation] == 'scenario'
							...
							@results1 = Result.where(:watershed_id => @scenario1, :crop_id => 0).includes(:description)
					...
					if @scenario2 > "0" then
						...
						if session[:simulation] == 'scenario'
							...
							@results2 = Result.where(:watershed_id => @scenario2, :crop_id => 0).includes(:description)
					...
					if @scenario3 > "0" then
						...
						if session[:simulation] == 'scenario'
							...
							@results3 = Result.where(:watershed_id => @scenario3, :crop_id => 0).includes(:description)
