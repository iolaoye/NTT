...
################################  RUN-FEM - simulate the selected scenario for FEM #################################
  ...
  def run_aplcat
    ...
    apex_string += aplcat.cpl_highest.to_s + "\t" + "  " + aplcat.cpl_lowest.to_s + "\t"  + "\t" + t('aplcat.parameter4') + "\n"
    #apex_string += "\n"
    ...
    apex_string += aplcat.tdn_highest.to_s + "\t" + "  " + aplcat.tdn_lowest.to_s + "\t"  + "\t" + t('aplcat.parameter5') + "\n"
    #apex_string += "\n"
    ...
    apex_string += aplcat.ndf_highest.to_s + "\t" + + "  " + aplcat.ndf_lowest.to_s + "\t"  + "\t" + t('aplcat.parameter6') + "\n"
    #apex_string += "\n"
    ...
    apex_string += aplcat.fir_highest.to_s + "\t" + + "  " + aplcat.fir_lowest.to_s + "\t"  + "\t" + t('aplcat.parameter8') + "\n"
    apex_string += "\n"
    #***** send file to server "
    unless
