...
################################  SHOW   #################################
  ...
  private
    ...
    def weather_params
      params.require(:weather).permit(:field_id, :latitude, :longitude, :simulation_final_year, :simulation_initial_year, :station_id, :station_way)
    end
end
