class AplcatResultsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_field_scenario_aplcat_results_path(@project, @field, @scenario) }
      format.json { head :no_content }
    end
  end
  ...
  private
    ...
    def aplcat_result_params
      params.require(:aplcat_result).permit(:month_id, :option_id, :calf_aws, :calf_dmi, :calf_gei, :calf_wi, :calf_wif, :calf_sme, :calf_sme, :calf_ni, :calf_tne, :calf_tnr, :calf_fne,
      :calf_une, :calf_eme, :calf_mme, :rh_aws, :rh_dmi, :rh_gei, :rh_wi, :rh_wif, :rh_sme, :rh_sme, :rh_ni, :rh_tne, :rh_tnr, :rh_fne, :rh_une, :rh_eme, :rh_mme,
      :fch_aws, :fch_dmi, :fch_gei, :fch_wi, :fch_wif, :fch_sme, :fch_sme, :fch_ni, :fch_tne, :fch_tnr, :fch_fne, :fch_une, :fch_eme, :fch_mme,
      :cow_aws, :cow_dmi, :cow_gei, :cow_wi, :cow_wif, :cow_sme, :cow_sme, :cow_ni, :cow_tne, :cow_tnr, :cow_fne, :cow_une, :cow_eme, :cow_mme,
      :bull_aws, :bull_dmi, :bull_gei, :bull_wi, :bull_wif, :bull_sme, :bull_ni, :bull_tne, :bull_tnr, :bull_fne, :bull_une, :bull_eme, :bull_mme)
    end
end
